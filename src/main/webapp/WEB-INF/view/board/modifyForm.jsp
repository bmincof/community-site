...
<body>
	<form action="modifyDo" method="post">
		...
		<div>
			...
			제목 : <input type="text" name="newTitle" value="${modifyRequest.title }" style="width:600px">
		</div>
		<div>
			내용 : <textarea name="newContent" rows=10 style="width:50%; resize:none">${modifyRequest.content }</textarea>
		</div>
		<button>글 수정</button>
		<button type="button" onclick="location.href='/board/detail/';">돌아가기</button>
	</form>
</body>
<script>
